import { c as createComponent, d as renderComponent, r as renderTemplate, m as maybeRenderHead, e as renderScript } from '../chunks/astro/server_nkSBzcqr.mjs';
import 'kleur/colors';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Thematic Deep Technology Insights and Market Analysis", "description": "Professional analysis of emerging technology opportunities and market trends" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, { "currentPath": "/" })} ${maybeRenderHead()}<main class="main"> <section class="hero hero-video"> <video autoplay muted loop playsinline preload="none" class="hero-background-video" id="hero-video"> <source src="/background-video.mp4" type="video/mp4"> </video> <div class="hero-overlay"></div> <div class="container"> <div class="hero-content"> <h1 class="hero-title">We're betting on deep technology innovation and adoption, from the <em>birthplace</em> of Silicon Valley.</h1> <p class="hero-subtitle">Novana's Stanford-based team produces in-house technology analyses, investment research briefs, and market trends writeups across edge computing, biotechnology, artificial intelligence, and other frontier industries.</p> </div> </div> </section> ${renderScript($$result2, "/Users/justinwang/Downloads/coding-projects/novanadeployed/src/pages/index.astro?astro&type=script&index=0&lang.ts")} <section class="articles"> <div class="container-narrow"> <h2>Latest Insights</h2> <div class="articles-list"> ${allArticles.map((article) => renderTemplate`${renderComponent($$result2, "ArticleCard", $$ArticleCard, { "article": article })}`)} </div> </div> </section> </main> ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
